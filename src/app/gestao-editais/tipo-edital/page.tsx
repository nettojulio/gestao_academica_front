...
const PageLista = () => {
    ...
    const adicionarRegistro = () => {
        router.push('/gestao-editais/tipo-edital/criar');
    };
    const editarRegistro = (item: any) => {
        router.push('/gestao-editais/tipo-edital/' + item.id);
    };
    const deletarRegistro = async (item: any) => {
        const confirmacao = await Swal.fire({
            title: `Você deseja deletar o tipo de edital ${item.nome}?`,
        ...
        if (confirmacao.isConfirmed) {
            try {
                ...
                if (response && response.data && response.data.error) {
                    ...
                    pesquisarRegistro();
                    Swal.fire({
                        title: "O tipo de edital foi deletado com sucesso!",
                        icon: "success",
                        customClass: {
                            popup: "my-swal-popup",
                            title: "my-swal-title",
