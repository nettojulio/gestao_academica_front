...
const estrutura: any = {
  ...
  uri: "agendamento/cancelamento/profissional", //caminho base
  ...
  cabecalho: { //cabecalho da pagina
    ...
    migalha: [
      { nome: 'Home', link: '/home' },
      { nome: 'Prae', link: '/prae' },
      { nome: 'Cancelamentos', link: '/prae/agendamentos/calendario/todos-cancelamentos' },
    ]
  },
...
const PageLista = () => {
  ...
  const adicionarRegistro = () => {
    router.push('/prae/agendamentos/calendario/agendamentos-por-aluno');
  };
