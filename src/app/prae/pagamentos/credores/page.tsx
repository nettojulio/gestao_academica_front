...
const estrutura: any = {
    ...
    uri: "credores", //caminho base

    cabecalho: { //cabecalho da pagina
        titulo: "Gerenciar Credores",
        migalha: [
            { nome: 'Home', link: '/home' },
            { nome: 'Prae', link: '/prae' },
            { nome: 'Gerenciar Credores', link: '/prae/listar-credores' },
        ]
    },
        ...
        try {
            ...
            if (response && response.data.errors != undefined) {
                ...
                if (response && response.data) {
                    ...
                    for (let i of data) {
                        let estudantes = "";
                        for (let estudante of i.estudantes) {
                            let aluno = estudante.aluno;
                            estudantes += aluno ? aluno.nome + " - " + aluno.cpf : "-";
                        }
                        i.nome = estudantes;
                    }
                    setDados(data);
