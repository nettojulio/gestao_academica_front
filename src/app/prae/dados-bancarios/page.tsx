...
const estrutura: any = {
  ...
  tabela: {
    ...
    colunas: [ //colunas da tabela
      { nome: "Titular", chave: "titular", tipo: "texto", selectOptions: null, sort: false, pesquisar: true }, //nome(string),chave(string),tipo(text,select),selectOpcoes([{chave:string, valor:string}]),pesquisar(booleano)
