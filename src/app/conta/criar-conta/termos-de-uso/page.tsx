...
export default function PageRegister() {
    ...
    return (
        <div className="flex flex-col items-center justify-center px-6 pt-10 mx-auto">
            <div className="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow">
                ...
                <div className="container">
                    ...
                    <p><strong>2. Aceitação do Termo de Uso e Política de Privacidade</strong></p>
                    ...
                    <p><strong>3. Legislação Aplicada</strong></p>
                    ...
                    <p><strong>4. Uso do Aplicativo</strong></p>
                    ...
                    <p><strong>6. Deveres do Usuário</strong></p>
                    ...
                    <p><strong>7. Responsabilidade da Administração Pública com os Dados Pessoais</strong></p>  
                    ...
                    <p><strong>9. Alterações dos Termos de Uso</strong></p>
                ...
                <p><strong>1. Introdução</strong></p>
                    ...
                    <p><strong>2. Aceitação da Política de Privacidade</strong></p>
                    <p>2.1 - Ao utilizar o Sistema de Gestão Universitária, o usuário confirma que leu, compreendeu e que aceita os termos e políticas aplicáveis e fica a eles vinculado.</p>
                    <p>2.2 - Caso não concorde com as regras presentes nestes Termos, o Usuário não poderá acessar e utilizar o sistema e dispor dos seus serviços.   .</p>
                    ...
                    <p><strong>4. Finalidade dos Dados Tratados</strong></p>
                    ...
                    <p><strong>5. Armazenamento dos Dados</strong></p>
                    ...
                    <p><strong>6. Segurança no Tratamento dos Dados Pessoais</strong></p>
                    ...
                    <p><strong>7. Compartilhamento de dados</strong></p>
                    ...
                    <p><strong>8. Alterações deste Aviso de Privacidade</strong></p>
                    ...
                    <p><strong>10. Isenção de responsabilidade</strong></p>
